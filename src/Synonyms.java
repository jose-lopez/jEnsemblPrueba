...
public class Synonyms {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DBRegistry reg2 = new DBRegistry(DBConnection.DataSource.ENSEMBLGENOMES);
        DBSpecies ek = reg2.getSpeciesByAlias("escherichia coli k12");
        ...
        DBRegistry reg = new DBRegistry(DBConnection.DataSource.ENSEMBLDB);
        DBSpecies hs = reg.getSpeciesByAlias("human");
