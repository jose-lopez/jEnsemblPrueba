...
public class Genes {
    ...
    public  static void main(String[] args) throws Exception {
        ...
        DBRegistry ensemblgenomesRegistry = new DBRegistry(DataSource.ENSEMBLGENOMES);
        System.out.println("1");
        
        DBCollectionSpecies sp1 = (DBCollectionSpecies) ensemblgenomesRegistry.getSpeciesByAlias("Pyrococcus abyssi");
